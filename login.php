...
<div id="login-container" class="animation-fadeIn">
    ...
    <div class="login-title text-center">
        <h1><i class="gi gi-flash"></i> <strong> CompuShop </strong><br><small>Please <strong>Login</strong></small></h1>
    </div>
    <!-- END Login Title -->
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        ...
                        <input type="text" id="login-email" name="login-user" class="form-control input-lg" placeholder="User">
                    </div>
                </div>
            </div>
            <div class="form-group">
